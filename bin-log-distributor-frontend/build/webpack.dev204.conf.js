...
const env = require('../config/dev204.env')

const dev204dev204WebpackConfig = merge(baseWebpackConfig, {
  module: {
...
if (config.dev204.bundleAnalyzerReport) {
  ...
  dev204dev204WebpackConfig.plugins.push(new BundleAnalyzerPlugin())
}

module.exports = dev204dev204WebpackConfig
